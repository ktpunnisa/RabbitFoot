...
public class UIMenu extends Canvas {
	...
	private void updateAnimation(long now) {
		...
		if (diffSelector == 0)
			gc.fillRoundRect(SceneManager.SCENE_WIDTH * 3 / 16 - 105, SceneManager.SCENE_HEIGHT * 3 / 4 - 35, 200, 70,
					40, 40);
		else if (diffSelector == 1)
			gc.fillRoundRect(SceneManager.SCENE_WIDTH / 2 - 105, SceneManager.SCENE_HEIGHT * 3 / 4 - 35, 200, 70, 40,
					40);
		else
			gc.fillRoundRect(SceneManager.SCENE_WIDTH * 13 / 16 - 105, SceneManager.SCENE_HEIGHT * 3 / 4 - 35, 200, 70,
					40, 40);
		gc.setFill(Color.WHITE);
		gc.drawImage(new Image(ClassLoader.getSystemResourceAsStream("ui/logo.png")),
				SceneManager.SCENE_WIDTH / 2 - 300, SceneManager.SCENE_HEIGHT / 4 - 100);
